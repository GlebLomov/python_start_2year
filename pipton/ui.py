...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_dir.setStyleSheet("background-color: rgb(170, 85, 255);")
        ...
        self.lw_files.setStyleSheet("background-color: rgb(255, 0, 255);\n"
"background-color: rgb(85, 255, 255);")
        self.lw_files.setObjectName("lw_files")
        self.lb_image = QtWidgets.QLabel(self.centralwidget)
        self.lb_image.setGeometry(QtCore.QRect(160, -10, 621, 501))
        self.lb_image.setStyleSheet("")
        self.lb_image.setObjectName("lb_image")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(150, 500, 641, 51))
...
"background-color: rgb(170, 85, 255);")
        ...
        self.btn_right.setStyleSheet("background-color: rgb(170, 85, 255);")
        self.btn_right.setObjectName("btn_right")
        self.horizontalLayout.addWidget(self.btn_right)
        self.btn_sharp = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.btn_sharp.setStyleSheet("background-color: rgb(170, 85, 255);")
        ...
        self.btn_bw.setStyleSheet("background-color: rgb(170, 85, 255);")
