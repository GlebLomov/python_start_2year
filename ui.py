...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.field_text.setGeometry(QtCore.QRect(10, 330, 871, 231))
        self.field_text.setObjectName("field_text")
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(30, 20, 541, 171))
        self.listWidget.setStyleSheet("background-color: rgb(255, 170, 255);")
        self.listWidget.setObjectName("listWidget")
        self.listWidget_2 = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget_2.setGeometry(QtCore.QRect(590, 20, 291, 171))
        self.listWidget_2.setStyleSheet("background-color: rgb(255, 170, 255);")
        self.listWidget_2.setObjectName("listWidget_2")
        self.button_note_create = QtWidgets.QPushButton(self.centralwidget)
        self.button_note_create.setGeometry(QtCore.QRect(50, 190, 201, 61))
        self.button_note_create.setStyleSheet("background-color: rgb(196, 204, 255);")
        self.button_note_create.setObjectName("button_note_create")
        self.button_note_del = QtWidgets.QPushButton(self.centralwidget)
        self.button_note_del.setGeometry(QtCore.QRect(320, 190, 191, 61))
        self.button_note_del.setStyleSheet("background-color: rgb(196, 204, 255);")
        self.button_note_del.setObjectName("button_note_del")
        self.button_note_save = QtWidgets.QPushButton(self.centralwidget)
        self.button_note_save.setGeometry(QtCore.QRect(150, 260, 281, 31))
        self.button_note_save.setStyleSheet("background-color: rgb(196, 204, 255);")
        self.button_note_save.setObjectName("button_note_save")
        self.button_tag_add = QtWidgets.QPushButton(self.centralwidget)
        self.button_tag_add.setGeometry(QtCore.QRect(570, 220, 141, 41))
        self.button_tag_add.setStyleSheet("background-color: rgb(196, 204, 255);")
        self.button_tag_add.setObjectName("button_tag_add")
        self.button_tag_del = QtWidgets.QPushButton(self.centralwidget)
        self.button_tag_del.setGeometry(QtCore.QRect(720, 220, 161, 41))
        self.button_tag_del.setStyleSheet("background-color: rgb(196, 204, 255);")
        self.button_tag_del.setObjectName("button_tag_del")
        self.button_tag_search = QtWidgets.QPushButton(self.centralwidget)
        self.button_tag_search.setGeometry(QtCore.QRect(590, 270, 256, 23))
        self.button_tag_search.setStyleSheet("background-color: rgb(196, 204, 255);")
        self.button_tag_search.setObjectName("button_tag_search")
        self.list_notes_label = QtWidgets.QLabel(self.centralwidget)
        self.list_notes_label.setGeometry(QtCore.QRect(240, 0, 256, 20))
        self.list_notes_label.setStyleSheet("color: rgb(0, 0, 0);")
        self.list_notes_label.setObjectName("list_notes_label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(690, 0, 256, 20))
        self.label_2.setObjectName("label_2")
        self.field_tag = QtWidgets.QLineEdit(self.centralwidget)
        self.field_tag.setGeometry(QtCore.QRect(610, 190, 256, 23))
